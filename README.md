...
[![🚀 Deploy to GitHub Pages](https://github.com/lucking7/esdeath-main/actions/workflows/deploy.yml/badge.svg)](https://github.com/lucking7/esdeath-main/actions/workflows/deploy.yml)
[![License](https://img.shields.io/github/license/lucking7/esdeath-main)](./LICENSE)
...
以确保代码通过 Lint 和 TypeScript 类型检查。

### 🎨 前端页面

```bash
# 构建静态HTML页面 (public/index.html)
pnpm build-web
```

## 🌐 在线访问

- **官方网站**: [nrrule.pages.dev](https://nrrule.pages.dev)
- **镜像站点**: [nrrule-mirror.pages.dev](https://nrrule-mirror.pages.dev)
...
# 在 Surge 配置文件中添加
[Rule]
RULE-SET,https://nrrule.pages.dev/List/non_ip/reject.conf,REJECT
...
rule-providers:
  reject:
    type: http
    behavior: domain
    url: 'https://nrrule.pages.dev/Clash/non_ip/reject.txt'
    ...
    "rule_set": [
      {
        ...
        "type": "remote",
        "format": "binary",
        "url": "https://nrrule.pages.dev/sing-box/non_ip/reject.json"
      }
    ],
    "rules": [
      {
...
**[🌟 Star](https://github.com/lucking7/esdeath-main)** | **[🐛 Report Issues](https://github.com/lucking7/esdeath-main/issues)** | **[📝 Documentation](https://nrrule.pages.dev)**

Made with ❤️ by [lucking](https://nrrule.pages.dev)
