...
class RuleValidator {
   ...
   * 判断是否为规则行
   */
  // eslint-disable-next-line @typescript-eslint/class-methods-use-this -- rule type detector does not access instance state
   ...
   * 简单的域名验证
   */
  // eslint-disable-next-line @typescript-eslint/class-methods-use-this -- domain validator does not access instance state
   ...
   * IP-CIDR 验证
   */
  // eslint-disable-next-line @typescript-eslint/class-methods-use-this -- CIDR validator does not access instance state
   ...
   * 检查重复行
   */
  // eslint-disable-next-line @typescript-eslint/class-methods-use-this -- duplicate line checker does not access instance state
   ...
   * 查找文件
   */
  // eslint-disable-next-line @typescript-eslint/class-methods-use-this -- file finder does not access instance state
