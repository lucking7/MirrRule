  ...
  },
  {
    ...
    files: [
      ...
      applyDefaultConfig({
        ...
        url: 'https://nrrule.pages.dev/List/non_ip/reject-no-drop.conf',
      }),
      applyDefaultConfig({
        path: 'List/reject-drop.list',
        url: 'https://nrrule.pages.dev/List/non_ip/reject-drop.conf',
      }),
    ],
  },
  {
  ...
  },
  {
    ...
    files: [
      ...
      applyDefaultConfig({
        ...
        url: 'https://nrrule.pages.dev/List/domainset/speedtest.conf',
      }),
    ],
  },
  {
    ...
    files: [
      ...
      applyDefaultConfig({
        ...
        url: 'https://nrrule.pages.dev/List/non_ip/global.conf',
        keepComments: true,
...
export const specialRules: SpecialRuleConfig[] = [
  {
    ...
    sourceFiles: [
      'https://nrrule.pages.dev/List/domainset/download.conf',
      'https://nrrule.pages.dev/List/non_ip/download.conf',
    ],
  ...
  },
  {
    ...
    sourceFiles: [
      'https://ruleset.lucking.moe/List/non_ip/apple_services.conf',
      'https://ruleset.lucking.moe/List/non_ip/apple_cn.conf',
      'https://ruleset.lucking.moe/List/domainset/apple_cdn.conf',
      'https://ruleset.lucking.moe/List/ip/apple_services.conf',
      'https://ruleset.lucking.moe/List/domainset/icloud_private_relay.conf',
    ],
    targets: ['surge', 'clash', 'singbox', 'loon'], // 🔧 添加多平台支持
    dedup: true,
    sort: true,
  ...
  },
  {
    ...
    sourceFiles: [
      'https://ruleset.lucking.moe/List/non_ip/microsoft.conf',
      'https://ruleset.lucking.moe/List/non_ip/microsoft_cdn.conf',
    ],
    targets: ['surge', 'clash', 'singbox', 'loon'], // 🔧 添加多平台支持
    dedup: true,
    sort: true,
  ...
  },
  {
    ...
    sourceFiles: [
      'https://ruleset.lucking.moe/List/domainset/reject.conf',
      'https://ruleset.lucking.moe/List/non_ip/reject.conf',
      'https://ruleset.lucking.moe/List/domainset/reject_extra.conf',
      'https://ruleset.lucking.moe/List/ip/reject.conf',
  ...
  },
  {
    ...
    sourceFiles: [
      'https://ruleset.lucking.moe/List/non_ip/domestic.conf',
      'https://ruleset.lucking.moe/List/ip/domestic.conf',
    ],
    targets: ['surge', 'clash', 'singbox', 'loon'], // 🔧 添加多平台支持
    dedup: true,
    sort: true,
  ...
  },
  {
    ...
    sourceFiles: [
      'https://ruleset.lucking.moe/List/non_ip/telegram.conf',
      'https://ruleset.lucking.moe/List/ip/telegram.conf',
      'https://ruleset.lucking.moe/List/ip/telegram_asn.conf',
    ],
    targets: ['surge', 'clash', 'singbox', 'loon'], // 🔧 添加多平台支持
    dedup: true,
    sort: true,
  ...
  },
  {
    ...
    sourceFiles: [
      'https://ruleset.lucking.moe/List/non_ip/my_direct.conf',
      'https://ruleset.lucking.moe/List/non_ip/direct.conf',
    ],
    targets: ['surge', 'clash', 'singbox', 'loon'], // 🔧 添加多平台支持
    dedup: true,
    sort: true,
  ...
  },
  {
    ...
    sourceFiles: [
      'https://ruleset.lucking.moe/List/non_ip/lan.conf',
      'https://ruleset.lucking.moe/List/ip/lan.conf',
    ],
    targets: ['surge', 'clash', 'singbox', 'loon'], // 🔧 添加多平台支持
    dedup: true,
    sort: false,
