...
export const downloadMockAndModules = task(
  ...
  await span.traceChildAsync('下载并解压 mock 和 sgmodule', async () => {
    try {
      ...
      console.log(picocolors.cyan('Extracting to temp directory...'));
      ...
      console.log(picocolors.cyan(`\nChecking file changes (${extractedFiles.length} files)...`));
      ...
      // 6) 打印摘要
      console.log(picocolors.cyan('\nSync complete:'));
      console.log(picocolors.green(`  New: ${newCount}`));
      console.log(picocolors.blue(`  Updated: ${updatedCount}`));
      ...
      if (newCount + updatedCount === 0) {
        ...
        console.log(picocolors.green(`\nSynced ${newCount + updatedCount} files`));
      }
    } catch (error) {
