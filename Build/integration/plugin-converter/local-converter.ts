...
/* eslint-disable regexp/no-super-linear-backtracking, regexp/optimal-quantifier-concatenation, @typescript-eslint/no-use-before-define -- legacy Loon regex patterns and shared parser/converter helpers are intentionally kept as-is for compatibility and readability */
